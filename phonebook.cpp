...
/*телефонная книжка с консольным интерфейсом
реализованная на основе алгоритма бинарного дерева, присутствуют
такие функции: поиск по имени, поиск по номеру, добавление контакта,
удаление контакта и вывод всей телефонной книжки*/
