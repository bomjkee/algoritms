...
бинарное дерево после ввода начала и конца отрезка, а также исчет 
количество вхождений заданного элемента и считает сумму на 
определенном интервале. Отрезки длина которых = 1 программа разбивает
на два подотрезка(матреиальные точки), у которых начало = концу.*/
